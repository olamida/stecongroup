...
class NewsletterController extends Controller
{
    ...
    public function index()
    {
        ...
        $newsletters = Campaign::all();
        return view('backend.newsletter.index', ['newsletters' => $newsletters]);
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        return redirect()->route('admin.newsletter.index')
            ->withFlashSuccess(__('alerts.backend.newsletters.created'));
    ...
    {
        //
        return view('backend.newsletter.edit', ['campaigns' => Campaign::findOrFail($id)]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.newsletter.index')->withFlashSuccess(__('alerts.backend.newsletters.updated'));
    }
    ...
    //first example to send beauty mail
    ...
    public function subscribe(Request $request)
    {
        ...
        if (Newsletter::hasMember('yusufnyahaya@gmail.com')) {
            return view('backend.customers.index')
                ->withFlashSuccess(__('alerts.backend.newsletters.updated'))
                ->withCustomers($customers);
        }
        else
        {
            $error = Newsletter::subscribe('sukuralld@gmail.com', 
                ['FNAME'=>'sukura', 'LNAME'=>'adeyemi']);
            return view('backend.customers.index')
                ->withFlashSuccess(__('alerts.backend.newsletters.updated'))
                ->withCustomers($customers);
        }
    ...
    {
        //
        $fromName = 'Stecongroup Nig. Ltd';
        $replyTo = 'stecongroupevents@gmail.com';
        $subject = 'Welcome Message for Test No3';
        ...
        print_r(Newsletter::lastActionSucceeded());
    }
