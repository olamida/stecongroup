...
@section('title', __('labels.backend.departments.management') . ' | ' . __('labels.backend.departments.create'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.departments.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
