        ...
        <div class="card-body">
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.categories.description'))->class('col-md-2 form-control-label')->for('description') }}
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.categories.image'))->class('col-md-2 form-control-label')->for('image') }}
